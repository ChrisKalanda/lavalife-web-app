...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="reg-page">
        <div class="reg-card">
            ...
            <!-- IMAGE GAUCHE -->
            <div class="reg-left">
                <!-- image définie en background CSS -->
            </div>
            ...
            <div class="reg-right">
                ...
                <div class="reg-title">Sign up</div>
                ...
                <div class="reg-field">
                    ...
                    <asp:DropDownList ID="ddlReason" runat="server" CssClass="reg-select">
                        ...
                        <asp:ListItem>Other interests</asp:ListItem>
                    </asp:DropDownList>
                </div>
                ...
                <div class="reg-bottom-text">
                    Already a member? <a href="~/Accounts/Login.aspx" runat="server" style="color:#ff0000;">Log in</a>
                </div>
